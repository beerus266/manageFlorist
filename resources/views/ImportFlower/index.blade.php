...
@push('CssFile')
    <link rel="stylesheet" href="{{ asset('css/cssImport.css')}}">
@endpush
@section('body-page')
        ...
        {{-- Button Create  --}}
            <div class="bg"></div>
            <div class="button" id="createImport"><i class="fas fa-pencil-alt fa-2x"></i></div>
        {{-- -------------------------------------------------- --}}
        <div class="action">
            <div class="row">
        ...
        {{-- -----------------------------------------  --}}
        <table class="table table-striped table-bordered" id="importFlowerTable" style="">
            <thead>
                <th>STT</th>
                <th>Ngày</th>
            ...
            <tbody>
                @foreach ( $dataAllImport as $import)
                    <tr>
                        <td value="{{$import->id}}">{{$loop->index+1}}</td>
                        <td>{{$import->date}}</td>
                        <td value="{{$import->customer_id}}">{{$import->name}}</td>
                        <td value="{{$import->flower_id}}">{{$import->flower_name}} {{$import->note}} </td>
                        <td>{{$import->tai}}T</td>
                        <td>{{$import->quantity}}</td>
                        <td>x {{$import->price}}</td>
                        <td>= {{$import->quantity * $import->price }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        {{-- ======================================================================================= --}}
        {{-- Modal create  --}}
        <div class="modal fade" id="modalCreateImport" tabindex="-2" role="dialog" disabled>
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<span id="errOmit" ><i class="fa fa-times-circle" aria-hidden="true"></i> Điền chính xác thông tin</span>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="importEdit"><i class="fas fa-save"></i> Lưu</button>    
                    </div>
                </div>
            </div>
        </div>
...
@push('JsFile')
    <script src="{{ asset('js/ImportFlower.js') }}"></script>
@endpush